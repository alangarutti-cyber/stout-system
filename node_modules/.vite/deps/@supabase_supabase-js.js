...
async function handleError3(error) {
  ...
  throw new AuthApiError(_getErrorMessage3(data), error.status || 500);
}
...
async function _request(fetcher, method, url, options) {
  ...
  const data = await _handleRequest3(fetcher, method, url + queryString, { headers, noResolveJson: options === null || options === void 0 ? void 0 : options.noResolveJson }, {}, options === null || options === void 0 ? void 0 : options.body);
