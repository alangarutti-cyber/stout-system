...
const MainLayout = () => {
  ...
  useEffect(() => {
    const loadUser = async () => {
      try {
        ...
        console.error("Erro ao carregar usuário do layout:", error);
  ...
  const hardcodedModules = [
    ...
    { id: 12, name: "Produtos", path: "cadastros/produtos", icon: Package, group: "Cadastros" },
    { id: 13, name: "Clientes", path: "cadastros/clientes", icon: Users, group: "Cadastros" },
    { id: 14, name: "Colaboradores", path: "cadastros/colaboradores", icon: Boxes, group: "Cadastros" },

    { id: 15, name: "Caixa", path: "caixa", icon: CircleDollarSign, group: "Operacional" },
    { id: 16, name: "Pedidos", path: "pedidos", icon: ShoppingCart, group: "Operacional" },

    { id: 17, name: "Configurações", path: "configuracoes", icon: Settings, group: "Configurações" },
    { id: 18, name: "Relatórios", path: "relatorios", icon: FileText, group: "Análises" },
  ];
